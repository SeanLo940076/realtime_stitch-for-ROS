...
void imageCallback(const sensor_msgs::ImageConstPtr &msg)
{
    ...
    cv::Mat imputimage = cv_ptr->image;
    ...
    cv::Mat outputimage = yoloimage.yoloresult;
...
int main(int argc, char **argv)
{
    ...
    image_transport::Subscriber sub = it.subscribe("/stitched_image/image_raw", 1, imageCallback);
